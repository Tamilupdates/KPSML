...
def cancel_mirror(update, context):
    ...
    if len(context.args) == 1:
        ...
        msg = f"Reply to an active <code>/{BotCommands.MirrorCommand[0]}</code> message which \
                was used to start the download or send <code>/{BotCommands.CancelMirror[0]} GID</code> to cancel it!"
